...
const TAGS: [ParserTag; 2] = [ParserTag::File, ParserTag::String];
    ...
    for line in text.lines() {
        ...
        o.insert(
            ...
            Value::String(if r {
                ...
                val.trim_matches(|c| c == '\'' || c == '"').into()
            }),
        );
    }
    Ok(Value::Object(o))
}
pub static OS_RELEASE: StaticParser = StaticParser::new(&DESCRIPTOR, parse);
