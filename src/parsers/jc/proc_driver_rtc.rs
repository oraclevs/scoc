...
pub static DESCRIPTOR: ParserDescriptor = ParserDescriptor {
    name: "proc-driver-rtc",
    aliases: &[],
    description: "JC 1.26.0 target `proc-driver-rtc` parser",
...
pub(crate) static PARSER: GenericParser = GenericParser::new(&DESCRIPTOR, GenericKind::KeyValue);
