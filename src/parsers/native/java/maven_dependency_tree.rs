...
pub static DESCRIPTOR: ParserDescriptor = ParserDescriptor {
    ...
    aliases: &[],
    description: "Structured human-readable output parser for `maven-dependency-tree`",
...
pub(crate) static PARSER: GenericParser = GenericParser::new(&DESCRIPTOR, GenericKind::Tree);
